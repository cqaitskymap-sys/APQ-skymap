...
import {
  ...
  environmentalParameterTrendData, fetchEnvironmentalRecords,
        ...
        actions={
          <>
            ...
            {canReview && record.reviewStatus === 'Draft' && (
              <Button size="sm" onClick={async () => { await reviewEnvironmentalRecord(record.id, actor, record); await load(); }}>Submit Review</Button>
            )}
            {canReview && record.reviewStatus === 'Under Review' && (
              <Button size="sm" onClick={async () => { await approveEnvironmentalRecord(record.id, actor, record); await load(); }}>Approve</Button>
            )}
          </>
        }
      />
