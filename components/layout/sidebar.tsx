...
import {
  ...
  BadgeCheck, Factory, FileSearch, Plus, CheckCircle, FileDown, Search, Link2, Microscope, Calendar, MessageSquare, RotateCcw, Library, Grid3X3, ListChecks, FileSignature, TrendingUp, FileCheck, PlayCircle, Monitor, Sparkles, Server, Code, PenTool, Lock, Wrench, MapPin, Thermometer, Droplets, PackagePlus, ShieldAlert, Boxes, Target, Layers, FilePlus, GraduationCap, Briefcase, Globe, Clock,
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Induction Training', href: '/training/induction', icon: Building2 },
      { label: 'JR Assignment', href: '/training/jr-assignment', icon: Briefcase },
      { label: 'JR Training Schedule', href: '/training/jr-training-schedule', icon: Clock },
      { label: 'Multi Target Training', href: '/training/multi-target-training', icon: Layers },
      { label: 'Target Training', href: '/training/target-training', icon: Target },
      { label: 'On Job Training', href: '/training/ojt', icon: Wrench },
      { label: 'Other Training Record', href: '/training/other-training', icon: FilePlus },
      { label: 'External Training', href: '/training/external', icon: Globe },
      { label: 'Annual Training Calendar', href: '/training/annual-plan', icon: Calendar },
      { label: 'Training Session', href: '/training/sessions', icon: Users },
      { label: 'Attendance', href: '/training/completion', icon: UserCheck },
      { label: 'Assessment', href: '/training/assessment', icon: PenTool },
      { label: 'Trainer', href: '/training/trainer', icon: GraduationCap },
      { label: 'Training Records', href: '/training/history', icon: History },
