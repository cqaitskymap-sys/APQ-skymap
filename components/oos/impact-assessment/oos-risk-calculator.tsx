...
import { computeRiskLevel, computeRiskScore, riskLevelColor } from '@/lib/oos-impact-records';
import { RiskBadge } from '@/components/oos/oos-sub-nav';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';

interface OosRiskCalculatorProps {
  severity: number;
  occurrence: number;
  detection: number;
...
export function OosRiskCalculator({ severity, occurrence, detection, onChange, disabled }: OosRiskCalculatorProps) {
