...
import { COMPLAINT_WIZARD_STEPS } from '@/lib/complaint-create-records';

export function ComplaintCreateWizard({ step }: { step: number }) {
  return (
    <div className="mb-6 flex flex-wrap gap-1">
      {COMPLAINT_WIZARD_STEPS.map((label, i) => (
        <div
          key={label}
          className={cn(
