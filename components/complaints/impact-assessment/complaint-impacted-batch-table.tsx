...
import { parseImpactedBatches } from '@/lib/complaint-impact-records';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Textarea } from '@/components/ui/textarea';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';

interface ComplaintImpactedBatchTableProps {
  value: string;
  onChange: (v: string) => void;
  disabled?: boolean;
}

export function ComplaintImpactedBatchTable({ value, onChange, disabled }: ComplaintImpactedBatchTableProps) {
