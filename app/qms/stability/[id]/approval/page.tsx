...
export default function StudyApprovalPage(props: { params: Promise<{ id: string }> }) {
  ...
  return <StabilityDetailView record={record} onRefresh={refresh} defaultTab="approval" />;
}
