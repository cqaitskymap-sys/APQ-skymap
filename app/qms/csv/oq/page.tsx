...
export default function OqPage() {
  ...
  const filtered = testScripts.filter((t) => t.test_phase === 'OQ');
  return (
    <CsvEntityList title="Operational Qualification (OQ)" description="OQ test scripts and execution records"
      ...
      renderForm={({ systems, onSuccess, onClose }) => <TestScriptForm systems={systems} onSuccess={onSuccess} onClose={onClose} phase="OQ" />}
    />
  );
}
